        ...
        <div class="editor">
            ...
            <div class="text">
                ...
                <div class="line">&nbsp;&nbsp;&nbsp;&nbsp; {{ open() }}<span class="div">div</span> <span
                        class="class">class</span>="<span class="class-name">personal</span>"{{ close() }}<span
                        class="personal"
                    >Personal</span>{{
                        open() }}<span class="div">div</span>{{ close() }}</div>

                <!-- <div class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ open() }}<span
                        class="p">p</span>{{ close() }}Age: 25{{ open() }}/<span class="p">p</span>{{ close() }}</div> -->

                <div class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ open() }}<span
                        class="p">p</span>{{ close() }}Location: Earth{{ open() }}/<span class="p">p</span>{{ close() }}
                </div>

                <div class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ open() }}<span
                        class="p">p</span>{{ close() }}Occupation: Web Developer{{
